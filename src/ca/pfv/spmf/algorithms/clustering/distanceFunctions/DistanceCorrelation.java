...
public class DistanceCorrelation extends DistanceFunction {
	...
	public double calculateDistance(DoubleArray vector1, DoubleArray vector2) {
		...
		return 1+correlation / (standardDeviation1 * standardDeviation2 * (vector1.data.length - 1));
	}
...
//		DoubleArray array1 = new DoubleArray(new double[] {3, 6, 0, 3, 6});
//		DoubleArray array2 = new DoubleArray(new double[] {1, 2, 0, 1, 2});
